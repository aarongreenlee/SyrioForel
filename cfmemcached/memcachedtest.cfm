<!-----------
	...
	memcached servers by making them a space delimited list and sending that in to the init function.
	...
	adobetvdev.o5kiti.0001.use1.cache.amazonaws.com:11211
------------>
<cfset variables.memcachedFactory = createObject("component","memcachedfactory").init("adobetvdev.o5kiti.0001.use1.cache.amazonaws.com:11211")>
